...
In every iteration of selection sort, the minimum element (considering ascending order) from the unsorted subarray is picked and moved to the sorted subarray.Write a C program to sort a list of elements using the selection sort algorithm.
...
// C program for implement of selection sort
//geeksforgeeks.org
